...
def FeatureNetwork2():
    ...
    conv1_1 = Convolution2D(16, (3, 3), padding='same', kernel_initializer='he_normal')(input_img)
    conv1_1 = BatchNormalization()(conv1_1)
    conv1_1 = LeakyReLU(0.1)(conv1_1)
    conv1_1 = d3_e_1g_mul2_reduce(conv1_1)

    conv2_1 = Convolution2D(32, (3, 3), padding='same', kernel_initializer='he_normal')(conv1_1)
    conv2_1 = BatchNormalization()(conv2_1)
    conv2_1 = LeakyReLU(0.1)(conv2_1)
    conv2_1 = MaxPool2D(pool_size=(2, 2), strides=(2, 2))(conv2_1)  # 32×32
    conv2_1_add = d3_e_1g_mul2_reduce(conv2_1)

    conv3_1 = Convolution2D(64, (3, 3), padding='same', kernel_initializer='he_normal')(conv2_1_add)
    conv3_1 = BatchNormalization()(conv3_1)
    conv3_1 = LeakyReLU(0.1)(conv3_1)
    conv3_1 = MaxPool2D(pool_size=(2, 2), strides=(2, 2))(conv3_1)  # 16×16
    conv3_1_add = d3_e_1g_mul2_reduce(conv3_1)

    conv4_1 = Convolution2D(128, (3, 3), padding='same', kernel_initializer='he_normal')(conv3_1_add)
    conv4_1 = BatchNormalization()(conv4_1)
    conv4_1 = LeakyReLU(0.1)(conv4_1)
    conv4_1 = MaxPool2D(pool_size=(2, 2), strides=(2, 2))(conv4_1)  # 8×8
    conv4_1_add = d3_e_1g_mul2_reduce(conv4_1)

    conv5_1 = Convolution2D(256, (3, 3), padding='same', kernel_initializer='he_normal')(conv4_1_add)
    conv5_1 = BatchNormalization()(conv5_1)
    conv5_1 = LeakyReLU(0.1)(conv5_1)
    conv5_1 = MaxPool2D(pool_size=(2, 2), strides=(2, 2))(conv5_1)  # 4×4
    conv5_1_add = d3_e_1g_mul2_reduce(conv5_1)

    de_conv5_1 = Convolution2D(128, (3, 3), padding='same', kernel_initializer='he_normal')(conv5_1_add)
    de_conv5_1 = BatchNormalization()(de_conv5_1)
    de_conv5_1 = LeakyReLU(0.1)(de_conv5_1)
    de_conv5_1 = UpSampling2D(size=(2, 2), interpolation='bilinear')(de_conv5_1)  # 8×8
    de_conv5_1_add = d3_e_1g_mul2_reduce(de_conv5_1)

    de_conv4_1 = Convolution2D(64, (3, 3), padding='same', kernel_initializer='he_normal')(de_conv5_1_add)
    de_conv4_1 = BatchNormalization()(de_conv4_1)
    de_conv4_1 = LeakyReLU(0.1)(de_conv4_1)
    de_conv4_1 = UpSampling2D(size=(2, 2), interpolation='bilinear')(de_conv4_1)  # 8×8
    de_conv4_1_add = d3_e_1g_mul2_reduce(de_conv4_1)

    de_conv3_1 = Convolution2D(32, (3, 3), padding='same', kernel_initializer='he_normal')(de_conv4_1_add)
    de_conv3_1 = BatchNormalization()(de_conv3_1)
    de_conv3_1 = LeakyReLU(0.1)(de_conv3_1)
    de_conv3_1 = UpSampling2D(size=(2, 2), interpolation='bilinear')(de_conv3_1)  # 8×8
    de_conv3_1_add = d3_e_1g_mul2_reduce(de_conv3_1)

    de_conv2_1 = Convolution2D(16, (3, 3), padding='same', kernel_initializer='he_normal')(de_conv3_1_add)
    de_conv2_1 = BatchNormalization()(de_conv2_1)
    de_conv2_1 = LeakyReLU(0.1)(de_conv2_1)
    de_conv2_1 = UpSampling2D(size=(2, 2), interpolation='bilinear')(de_conv2_1)  # 8×8
    de_conv2_1_add = d3_e_1g_mul2_reduce(de_conv2_1)

    de_conv1_1 = Convolution2D(1, (3, 3), padding='same', kernel_initializer='he_normal', activation='sigmoid')(
        de_conv2_1_add)

    model = Model(inputs=input_img, outputs=[conv1_1, conv2_1_add, conv3_1_add, conv4_1_add, conv5_1_add, de_conv1_1])
    return model
...
def RRL():
    ...
    feature1_1, feature2_1, feature3_1, feature4_1, feature5_1, feature6_1 = model1.output
    feature1_2, feature2_2, feature3_2, feature4_2, feature5_2, feature6_2 = model2.output


    a_feature1_1 = Convolution2D(16, (1, 1), padding='same', kernel_initializer='he_normal')(feature1_1)
    a_feature1_1 = BatchNormalization()(a_feature1_1)
    a_feature1_1 = LeakyReLU(0.1)(a_feature1_1)

    as_feature1_1 = Convolution2D(16, (1, 1), padding='same', kernel_initializer='he_normal')(feature1_1)
    as_feature1_1 = BatchNormalization()(as_feature1_1)
    as_feature1_1 = Lambda(lambda x: K.sigmoid(x))(as_feature1_1)

    a_feature1_2 = Convolution2D(16, (1, 1), padding='same', kernel_initializer='he_normal')(feature1_2)
    a_feature1_2 = BatchNormalization()(a_feature1_2)
    a_feature1_2 = LeakyReLU(0.1)(a_feature1_2)

    as_feature1_2 = Convolution2D(16, (1, 1), padding='same', kernel_initializer='he_normal')(feature1_2)
    ...
    con_1 = Convolution2D(32, (3, 3), padding='same', kernel_initializer='he_normal')(ccon_1)
    con_1 = BatchNormalization()(con_1)
    con_1 = LeakyReLU(0.1)(con_1)
    con_1 = Convolution2D(32, (3, 3), padding='same', kernel_initializer='he_normal')(con_1)
    con_1 = BatchNormalization()(con_1)
    ...
    class_models_train = Model(inputs=[model1.input, model2.input],
                               outputs=[branch5_fc3, branch4_fc3, branch3_fc3, loss_5, loss_4,
                                        loss_3, feature6_1, feature6_2])
    class_models_test = Model(inputs=[model1.input, model2.input], outputs=[branch5_fc3])
    return class_models_train, class_models_test
